    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Buttons<span>Elements</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
                <div class="container">
                	<h2 class="title">Default Style</h2><!-- End .title -->

                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-primary btn-rounded">Button text</a>
		                	</div><!-- End .btn-wrap -->
                	...
                	<h2 class="title">Border Style</h2><!-- End .title -->

                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-outline-primary btn-rounded">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
		                ...
		                <div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-outline-dark btn-rounded">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-outline-dark">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-outline-dark btn-round">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                	</div><!-- End .row -->

                	<hr class="mt-3 mb-4">
                	<h2 class="title">Button With Icon Style</h2><!-- End .title -->

                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-primary btn-rounded"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-primary"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-primary btn-round"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
		                ...
		                <div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-primary btn-rounded"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-primary"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-primary btn-round"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                	</div><!-- End .row -->
                	...
                	<h2 class="title">Border Style With Icons</h2><!-- End .title -->

                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-outline-primary btn-rounded"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-outline-primary"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-outline-primary btn-round"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-outline-primary"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-outline-primary btn-round"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                	</div><!-- End .row -->
                	...
                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-outline-dark btn-rounded"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-outline-dark"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-outline-dark btn-round"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
		                ...
		                <div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-outline-dark btn-rounded"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-outline-dark"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-outline-dark btn-round"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                	</div><!-- End .row -->
                	...
                	<h2 class="title">Buttons With Shadow Style</h2><!-- End .title -->

                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-primary btn-rounded btn-shadow">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-primary btn-shadow">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-primary btn-round btn-shadow">Button text</a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	               	</div><!-- End .row -->
                	...
                	<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-primary btn-rounded btn-shadow"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-primary btn-shadow"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-primary btn-round btn-shadow"><span>Button text</span><i class="icon-long-arrow-right"></i></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
		                ...
		                <div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Rounded Corners Style</span>
		                		<a href="#" class="btn btn-primary btn-rounded btn-shadow"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                		...
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
		                		<span>Square Style</span>
		                		<a href="#" class="btn btn-primary btn-shadow"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
	                	...
	                	<div class="col-6 col-lg-4 col-xl-2">
		                	<div class="btn-wrap">
		                		<span>Round Style</span>
		                		<a href="#" class="btn btn-primary btn-round btn-shadow"><i class="icon-long-arrow-right"></i><span>Button text</span></a>
		                	</div><!-- End .btn-wrap -->
		                </div><!-- End .col-md-4 col-lg-2 -->
                	</div><!-- End .row -->
                	...
                	<h2 class="title">Simple Button Styles</h2><!-- End .title -->

                	<div class="row">
                		<div class="col-12">
                			<a href="#" class="btn btn-link">Button Text</a>
                			<a href="#" class="btn btn-link"><span>Button Text</span><i class="icon-long-arrow-right"></i></a>
                			<a href="#" class="btn btn-link"><i class="icon-long-arrow-right"></i><span>Button Text</span></a>

                			<a href="#" class="btn btn-link btn-link-dark">Button Text</a>
                			<a href="#" class="btn btn-link btn-link-dark"><span>Button Text</span><i class="icon-long-arrow-right"></i></a>
                			<a href="#" class="btn btn-link btn-link-dark"><i class="icon-long-arrow-right"></i><span>Button Text</span></a>
                		</div><!-- End .col-12 -->
                	</div><!-- End .row -->
            ...
            <div class="container">
            	<h2 class="title mb-3">Button on Backgrounds</h2><!-- End .title -->
            </div><!-- End .container -->

            <div class="bg-image bg-overlay pt-5 pb-6 mb-5" style="background-image: url(assets/images/backgrounds/bg-1.jpg)">
            	<div class="container">
            		<div class="row">
                		<div class="col-6 col-lg-4 col-xl-2">
	                		<div class="btn-wrap">
